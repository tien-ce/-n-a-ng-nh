...
LIGHT_VAL light_val;
SOID_VAL soid_val;
ThingsBoard_VAL things_val = {&re_val, &light_val, &soid_val, WIFI_SSID, WIFI_PASSWORD, THINGSBOARD_SERVER, TOKEN, THINGSBOARD_PORT, CLIENT_ID, PASSWORD};
/*----------------------------------------------------------------*/
...
void setup()
{
  ...
  task.addTask(TaskSoid, "Soil", 2048, 32, 1000, &soid_val);
